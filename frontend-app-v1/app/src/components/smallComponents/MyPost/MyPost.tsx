...
import useGetIsLikedByMe from "../../../hooks/post/useGetIsLikedByMe";
...
export default function MyPost({
  ...
  const [isLikedByMe, setIsLikedByMe] = useGetIsLikedByMe(post.id);
    ...
    <div className={styles.card}>
          ...
          <div>
            ...
            <dialog ref={dialogRef}>
              ...
              <div className={styles.dialogButtons}>
                ...
                <button onClick={confirmPostDeletion}>confirm</button>
              </div>
            </dialog>
          </div>
        )}
      ...
      <div className={styles.buttonsWrapper}>
        ...
        >
          ...
          <span>
            {isLikedByMe == true ? "Liked" : "Like"} ({likeCount})
          </span>
        </button>
        <button
          type="button"
          className={`${styles.actionButton} ${
            isLikedByMe == false ? styles.disliked : ""
          }`}
        ...
        >
          ...
          <span>
            {isLikedByMe == false ? "Disliked" : "Dislike"} ({dislikeCount})
          </span>
        </button>
        <button
          type="button"
